...
export default function EventItem(props) {
  ...
  return (
    <div className="flex flex-col w-[275px] h-[275px] md:h-[300px] md:w-[300px] border shadow-[0px_0px_40px] shadow-[#ff00ff] p-5 mt-10 bg-transparent bg-cover	items-center ">
