...
const Contactitem = (props) => {
  return (
    <div className='text-white'>
      <div className="mx-auto flex flex-col h-[275px] w-[275px] md:h-[350px] md:w-[350px] border shadow-[0px_0px_40px] shadow-cyan-400  my-10 items-center bg-center">
        <h1 className='text-xl md:text-2xl mt-5 md:mt-10 font-semibold'>{props.heading}</h1>
