  ...
  return (
    <div  className="bg-black text-white p-4">
      <EventDetails title="The Web Slasher" description="Every web dev aspires to make a polished website but they all end up
        ...
        these unethical and annoying features web devs implement." details="Submit the website via email on or before 09-02-2023" type="Online" teamsize="Max 3 members" deadline="09-02-2023"/>
