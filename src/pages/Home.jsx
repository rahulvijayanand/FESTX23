  ...
  return (
    <div className="text-white">
      ...
      <div className='w-full'>
        <div className='max-w-[1920px] grid lg:grid-cols-2 2xl:grid-cols-2'>
          <img className='w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] xl:w-[400px] xl:h-[400px]  mx-auto mt-10' src={Logo} alt="/" />
          <div className=' flex flex-col justify-center'>
            <h1 className='px-10 lg:text-5xl md:text-4xl my-5 sm:text-3xl font-bold py-2'>ABOUT FESTX</h1>
            <p className='px-10 xl:pr-20 2xl:pr-auto lg:pr-auto text-justify lg:text-3xl md:text-2xl sm:text-1xl'>FESTX is an annual symposium hosted by the Department of Computer Science and 
      ...
      <div className='w-full py-16'>
        ...
        <div className='max-w-[1620px] mx-auto grid md:grid-cols-1'>
          <p className='xl:mx-auto sm:w-[500px] md:w-[768px] lg:w-[1024px] px-10 my-4 text-justify lg:text-3xl md:text-2xl sm:text-1xl'>Entrepreneurship with 
      ...
      <div className='w-full'>
        <div className='max-w-[1920px] grid lg:grid-cols-2'>
          ...
          <div className='flex flex-col '>
            ...
            <p className='text-justify 2xl:pr-auto px-10 lg:text-3xl md:text-2xl sm:text-1xl'>Sri Sairam Engineering College, Chennai, established in the year 1995 by 
      ...
      <div className='w-full'>
        <div className='max-w-[1920px] grid lg:grid-cols-2'>
          <img className='xl:mt-20 w-[250px] 2xl:mt-16 h-[250px] sm:w-[350px] sm:h-[350px] lg:mt-32 rounded-2xl mx-auto my-4' src={CSBS} alt="/" />
          <div className='flex flex-col 2xl:mt-10'>
            ...
            <p className=' text-justify px-10 2xl:pr-auto lg:text-3xl md:text-2xl sm:text-1xl'>CSBS is a steadily growing department and is gaining popularity among 
