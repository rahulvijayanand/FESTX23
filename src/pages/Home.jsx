      ...
      <div className='w-full'>
        <div className='max-w-[1920px] grid lg:grid-cols-2 2xl:grid-cols-2'>
          ...
          <div className=' flex flex-col justify-center'>
            ...
            <p className='px-10 xl:pr-20 2xl:pr-auto lg:pr-0 text-justify lg:text-3xl md:text-2xl sm:text-1xl'>FESTX is an annual symposium hosted by the Department of Computer Science and 
